export const releaseDirectoryName = "mediapipe-0.10.35-face-landmarker-float16-v1";
...
export const assets = [
  packageAsset("vision_wasm_internal.js", "wasm/vision_wasm_internal.js", "wasm-loader-simd"),
  packageAsset("vision_wasm_internal.wasm", "wasm/vision_wasm_internal.wasm", "wasm-binary-simd"),
  packageAsset(
...
export const remoteAssets = [
  ...
  },
  {
    ...
    requiredForOffline: true,
    role: "license",
    source: "https://raw.githubusercontent.com/google-ai-edge/mediapipe/v0.10.35/LICENSE",
    version: runtimeVersion,
  },
  {
