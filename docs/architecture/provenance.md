...
| `Rock-Atikhom/smile_detection` `apps/web/src/vision/face-frame-pump.ts`                               | `4b78615bcc32eb9579fb39020df02ca59943ca09` | `src/vision/face-frame-pump.ts`                                            | Adapted one-capture backpressure, bounded frame dimensions, generation invalidation, and bitmap cleanup.                    |
| `Rock-Atikhom/smile_detection` `apps/web/src/vision/runtime-loader.ts`                               | `4b78615bcc32eb9579fb39020df02ca59943ca09` | `src/vision/runtime-loader.ts`                                            | Adapted local manifest verification, asset integrity checks, and SIMD-to-baseline Face Landmarker fallback.               |
| `Rock-Atikhom/smile_detection` `apps/web/src/vision/worker-runtime.ts`                               | `4b78615bcc32eb9579fb39020df02ca59943ca09` | `src/vision/worker-runtime.ts`                                            | Adapted generation cancellation and transferred-bitmap disposal; calibration and normalized observations are new additions. |
